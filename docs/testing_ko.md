...
현재 저장소에는 SDK/Core/Plugins 계약 계층과 정적 배포 gate의 증거가 있습니다. 실제 Windows 서비스 등록, Docker/NAS 설치, 서명 컴포넌트 배포, 실제 Browser Worker 탐색과 데스크톱/모바일/차량 재생은 별도 릴리스 gate로 남아 있습니다.
