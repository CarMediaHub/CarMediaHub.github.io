...
| --- | --- | --- |
| Node.js Core runtime | Verified | TypeScript build and Core `153/153` regression on the supported development host. |
| SDK and Wire Protocol v0.1 | Verified | SDK `40/40`, strict Manifest/error/Wire contracts and Memory Runtime tests. |
| Official plugin packages | Verified | Six package manifests, catalog alignment and package verification pass. |
